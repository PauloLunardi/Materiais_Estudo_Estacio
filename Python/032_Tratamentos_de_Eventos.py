...
Crie um arquivo do Python chamado eventomouse.
Importe o tkinter.
Crie uma função para mapear as coordenadas do mouse.
Crie uma janela.
Crie um rótulo pedindo para movimentar o mouse.
Faça a ligação da captura do movimento com a função de mapeamento das coordenadas.
Rode a janela principal.
"""
